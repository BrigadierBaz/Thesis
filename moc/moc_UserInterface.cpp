...
QT_MOC_LITERAL(3, 37, 27), // "on_agentRadius_valueChanged"
QT_MOC_LITERAL(4, 65, 2), // "_r"
QT_MOC_LITERAL(5, 68, 28), // "on_numNeighbors_valueChanged"
QT_MOC_LITERAL(6, 97, 2), // "_n"
QT_MOC_LITERAL(7, 100, 32), // "on_neighborDistance_valueChanged"
QT_MOC_LITERAL(8, 133, 2), // "_d"
QT_MOC_LITERAL(9, 136, 21) // "on_restartSim_clicked"

    },
    "UserInterface\0on_pushButton_clicked\0"
    "\0on_agentRadius_valueChanged\0_r\0"
    "on_numNeighbors_valueChanged\0_n\0"
    "on_neighborDistance_valueChanged\0_d\0"
    "on_restartSim_clicked"
};
...
void UserInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_agentRadius_valueChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: _t->on_numNeighbors_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->on_neighborDistance_valueChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 4: _t->on_restartSim_clicked(); break;
        default: ;
        }
    }
}
